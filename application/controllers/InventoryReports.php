...
class InventoryReports extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['title'] = 'Receipts';
        $this->load->view('inventory_reports_view', $data);
...
//**************************************user defined*************************************************
    function response_rows($filter_value,$order_by=null){
      ...
      null,
 'pos_payment.*,pos_payment.receipt_no,pos_invoice.*,customers.customer_name',
							array(
