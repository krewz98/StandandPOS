    ...
    <tr>
        <td width="45%" valign="top">
            ...
            <address>
                ...
                <abbr title="Phone">P:</abbr> <?php echo $purchase_info->landline; ?>
            </address>
        ...
        <td width="50%" align="right">
            <h4>Receipt No.</h4>
            <h4 class="text-navy"><?php echo $r->receipt_no; ?></h4>
        ...
        <tbody>
            <?php foreach($po_items as $item){ ?>
                <tr>
                    ...
                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->po_qty,2); ?></td>
