            ...
            <tr>
                <td width="45%" valign="top">
                    ...
                    <address>
                        ...
                        <abbr title="Phone">P:</abbr> <?php echo $delivery_info->landline; ?>
                    </address>
                ...
                <td width="50%" align="right">
                    ...
                    <p>
                        ...
                        <span><strong>Due Date : </strong> <?php echo  date_format(new DateTime($delivery_info->date_received),"m/d/Y"); ?></span><br />
