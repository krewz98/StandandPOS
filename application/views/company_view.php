                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <div class="col-md-7">
                                                           <div class="input-group">
															...
															<input type="text" name="company_id" value="<?php echo $company->company_id; ?>" class="form-control" placeholder="Company Name" style="display:none;">
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <div class="col-md-7">
                                                           <div class="input-group">
                                                               ...
                                                               <input type="text" name="company_address" value="<?php echo $company->company_address; ?>" class="form-control" placeholder="Company Address" data-error-msg="Company address is required!" required>
                                                           </div>
                                                       </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <div class="col-md-7">
                                                           <div class="input-group">
                                                               ...
                                                               <input type="text" name="tin_no"  value="<?php echo $company->tin_no; ?>" class="form-control" placeholder="Lastname" data-error-msg="Tin No. is required!">
                                                           </div>
                                                       </div>
                                                   </div>
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <div class="col-md-7">
                                                           <div class="input-group">
                                                               ...
                                                               <input type="text" name="registered_to" value="<?php echo $company->registered_to; ?>" class="form-control" placeholder="Registered to" data-error-msg="Registered to is required!">
                                                           </div>
                                                       </div>
                                                   </div>

                                                   <div class="form-group">
                                                       <label class="col-md-2 col-md-offset-1 control-label"> Computer Terminal :</label>
                                                       <div class="col-md-7">
                                                           <div class="input-group">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-users"></i>
                                                                </span>
                                                               <input type="text" name="terminal" value="<?php echo $company->terminal; ?>" class="form-control" placeholder="Terminal" data-error-msg="Terminal is required!">
                                                           </div>
                                                       </div>
                                                   </div>
