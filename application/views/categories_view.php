                                                    ...
                                                    <div class="panel-body">
                                                        <form id="frm_category" role="form" class="form-horizontal row-border">
                                                            <div class="form-group">
                                                                <label class="col-md-2 col-md-offset-2 control-label">* Category Name :</label>
                                                                <div class="col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-2 col-md-offset-2 control-label">* Category Description :</label>
                                                                <div class="col-md-4">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color:#2ecc71;">
                                ...
                                <h4 id="category_title" class="modal-title" style="color: #ecf0f1;"><span id="modal_mode">Category Information</span></h4>
                            </div>
    ...
    $(document).ready(function(){
        ...
        var bindEventHandlers=(function(){
            ...
            $('#btn_cancel').click(function(){
                $('#modal_new_category').modal('toggle');
                showList(true);
            });
